                            ...
                            <form action="#">
                               ...
                               <table>
                                        ...
                                        <tbody>
                                            ...
                                            $query=mysqli_query($conn,"select `order`.*,order_status.name as order_status_str from `order`,order_status where `order`.user_id='$user_id' and order_status.id=`order`.order_status");
